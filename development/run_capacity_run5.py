"""
CHARLIEC – RUN 5 CAPACITY TEST.
Runs matrix run 5 locally; produces Live Results/Generator Capacity Run 5.txt.
...
OUTPUT_FILE = REPO_ROOT / "Live Results" / "Generator Capacity Run 5.txt"
...
def main():
    ...
    # Build deliverable per CHARLIEC RUN 5 spec (same fields as Run 1)
    lines = [
        "CHARLIEC – RUN 5 CAPACITY TEST",
        "===============================",
        "",
