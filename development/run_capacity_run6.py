"""
CHARLIEC – RUN 6 CAPACITY TEST.
Runs matrix run 6 locally; produces Live Results/Generator Capacity Run 6.txt.
...
OUTPUT_FILE = REPO_ROOT / "Live Results" / "Generator Capacity Run 6.txt"
...
def main():
    ...
    # Build deliverable per CHARLIEC RUN 6 spec (same fields as Run 1)
    lines = [
        "CHARLIEC – RUN 6 CAPACITY TEST",
        "===============================",
        "",
