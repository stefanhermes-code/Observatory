"""
CHARLIEC – RUN 3 CAPACITY TEST.
Runs matrix run 3 locally with 720s max; produces Live Results/Generator Capacity Run 3.txt.
...
OUTPUT_FILE = REPO_ROOT / "Live Results" / "Generator Capacity Run 3.txt"
...
def main():
    ...
    # Build deliverable per CHARLIEC RUN 3 spec (same fields as Run 1)
    lines = [
        "CHARLIEC – RUN 3 CAPACITY TEST",
        "===============================",
        "",
