"""
CHARLIEC – RUN 2 CAPACITY TEST.
Runs matrix run 2 locally with 720s max; produces Live Results/Generator Capacity Run 2.txt.
...
OUTPUT_FILE = REPO_ROOT / "Live Results" / "Generator Capacity Run 2.txt"
...
def main():
    ...
    # Build deliverable per CHARLIEC RUN 2 spec (same fields as Run 1)
    lines = [
        "CHARLIEC – RUN 2 CAPACITY TEST",
        "===============================",
        "",
