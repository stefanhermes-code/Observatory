...
def render_report(
    ...
    # Sections with development blocks (order from REPORT_SECTIONS, excluding Strategic Implications for blocks)
    ...
    # Strategic Implications (synthesised, no evidence list)
    ...
    lines.append("")
    implications = [
        "**Demand:** Underlying demand for polyurethanes and key feedstocks is expected to remain supported by applications in construction, automotive, footwear, adhesives, and coatings, with regional and segment-specific variation.",
        "**Technology and sustainability:** Innovation in recycling, bio-based materials, and sustainable production is likely to accelerate, affecting product portfolios and value chain positioning.",
        "**Supply and capacity:** Ongoing capacity and investment activity indicates industry commitment to meeting demand and improving regional and product coverage.",
        "**Regulation and circularity:** Regulatory and sustainability pressures are likely to reinforce focus on circular economy, recycling, and lower-carbon solutions.",
    ]
