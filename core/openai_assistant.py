...
def build_run_package(
    ...
    user_message_parts.extend([
        ...
        "- **CRITICAL - URLs must come from web search results ONLY**: Use **ONLY** URLs that web search returns. **DO NOT invent, construct, guess, or fabricate URLs**. If web search does not return a URL for a news item, **DO NOT include that item**. Fake URLs (404 errors) are unacceptable - users must be able to click through to verify the news.",
        ...
        "- **URL Examples**: '— ICIS (2025-01-15) https://www.icis.com/news/article' or '— Bloomberg (2025-01-15) https://www.bloomberg.com/news/article' (these URLs must come from web search results, not be invented)",
        "- **If no URL available from web search**: DO NOT include that news item at all - verification via URL is mandatory. If web search does not return a URL, skip that item entirely. Do not invent a URL.",
        "- **URL verification**: The URL must come directly from web search results and lead to the actual article/press release. Verify the date matches what you're reporting before including.",
        ...
        "- **URLs must come ONLY from web search results** - DO NOT invent, construct, or guess URLs. If web search does not return a URL, DO NOT include that item.",
        "- If an item does not have a URL from web search, DO NOT include it - skip it entirely",
        "- Verify the URL works and shows the correct publication date (the URL must be real, not a 404)",
        "",
